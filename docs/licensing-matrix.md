...
- Public SAM API and extract access is documentation-supported but not yet live-verified for Outlays; Gate 3 P2 approved-key probes returned empty 404 responses and no rate-limit headers.
